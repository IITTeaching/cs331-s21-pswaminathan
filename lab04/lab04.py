...
class ArrayList:
    ...
    def append(self, value):
        ...
        if(self.len == 0):
          newArr = [None]
          self.data = ConstrainedList.create(newArr)
    ...
    def insert(self, idx, value):
        ...
        if self.len == 0:
          Arr = [None]
          self.data = ConstrainedList.create(Arr)
          self.data[0] = value
        elif(self.len == idx):
          self.append(value)
          self.len-=1
          ...
          if(len(self.data)==self.len):
            ...
            Arr = [None]*len(self.data)
          for x in range(idx):
            Arr[x] = self.data[x]
          Arr[idx] = value
          for x in range(idx+1,self.len+1):
            Arr[x] = self.data[x-1]
          self.data = ConstrainedList.create(Arr)
        self.len += 1
        ### END SOLUTION
    ...
    def min(self):
        ...
        ### BEGIN SOLUTION
        minimumVal = self.data[0]
        for x in range(self.len):
          if(self.data[x]<minimumVal):
            minimumVal = self.data[x]
        return minimumVal
        ### END SOLUTION
    ...
    def max(self):
        ...
        ### BEGIN SOLUTION
        maximumVal = self.data[0]
        for x in range(0,self.len):
          if(self.data[x]>maximumVal):
            maximumVal = self.data[x]
        return maximumVal
        ### END SOLUTION
    ...
    def __add__(self, other):
        ...
        for y in range(other.len):
          newArr.append(other.data[y])

        newList = ArrayList(len(newArr))
        newList.data = ConstrainedList.create(newArr)
        return newList
        ### END SOLUTION
    ...
    def copy(self):
        ...
        for x in range(self.len):
          ...
          nlist.append(self.data[x])
        arraylst = ArrayList()

        arraylst.data = ConstrainedList.create(nlist)
        return arraylst
        ### END SOLUTION
